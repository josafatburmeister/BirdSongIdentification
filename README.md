...
Besides the Xeno-Canto database, several other datasets that include recordings of bird vocalizations are publicly available. These include the _Chernobyl_ dataset [[14](#cite-chernobyl)], the _Warblr_ dataset [[38](#cite-warblr)], the _freefield1010_ dataset [[37](#cite-freefield1010)], the _PolandNFC_ dataset [[38](#cite-warblr), [29](#cite-poland-nfc)], the _Birdvox-Full-Night_ dataset [[23](#cite-birdvox)], and the _NIPS4B_ dataset [[24](#cite-nips4bplus)]. While the other datasets mentioned before only include presence-absence tags for bird vocalizations, the NIPS4B dataset also provides species tags [[24](#cite-nips4bplus)]. The _NIPS4BPlus_ dataset provides time-precise annotations of bird vocalizations for a subset of the recordings in the NIPS4B dataset [[24](#cite-nips4bplus)].
